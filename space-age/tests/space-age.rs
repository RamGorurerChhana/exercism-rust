...
fn earth_age() {
    ...
    assert_eq!(31.69, Earth::years_during(&duration));
...
fn mercury_age() {
    ...
    assert_eq!(280.88, Mercury::years_during(&duration));
}
...
fn venus_age() {
    ...
    assert_eq!(9.78, Venus::years_during(&duration));
}
...
fn mars_age() {
    ...
    assert_eq!(35.88, Mars::years_during(&duration));
}
...
fn jupiter_age() {
    ...
    assert_eq!(2.41, Jupiter::years_during(&duration));
}
...
fn saturn_age() {
    ...
    assert_eq!(2.15, Saturn::years_during(&duration));
}
...
fn uranus_age() {
    ...
    assert_eq!(0.46, Uranus::years_during(&duration));
}
...
fn neptune_age() {
    ...
    assert_eq!(0.35, Neptune::years_during(&duration));
}
